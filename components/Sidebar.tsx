    ...
    <aside className="w-[280px] flex-shrink-0 flex flex-col border-r border-gray-200 bg-gray-50">
      ...
      <nav className="flex-1 py-4 overflow-y-auto">
        ...
        <div className="mb-6">
          ...
          <Link href="/trending" className={`sidebar-item ${pathname === "/trending" ? "active" : ""}`}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Link href="/search" className={`sidebar-item ${pathname === "/search" ? "active" : ""}`}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Link href="/bookmarks" className={`sidebar-item ${pathname === "/bookmarks" ? "active" : ""}`}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
