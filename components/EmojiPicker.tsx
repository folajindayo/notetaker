    ...
    <div className="absolute z-50 mt-2 w-80 bg-white border-2 border-gray-200 rounded-xl shadow-2xl">
      ...
      <div className="flex gap-1 p-2 border-b border-gray-200 overflow-x-auto">
        {Object.entries(emojiCategories).map(([key, category]) => (
          <button
            ...
            className={`flex-shrink-0 p-2 text-xl rounded-lg transition-all ${
      ...
      <div className="p-3 max-h-64 overflow-y-auto">
        <div className="grid grid-cols-8 gap-1">
          {emojiCategories[activeCategory as keyof typeof emojiCategories].emojis.map((emoji, i) => (
            <button
              key={i}
              onClick={() => {
                onEmojiSelect(emoji);
              ...
              className="text-2xl p-2 hover:bg-gray-100 rounded transition-all"
              title={emoji}
            >
              {emoji}
            </button>
